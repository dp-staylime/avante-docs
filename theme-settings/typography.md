...
| --------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| Presets (1–8)   | Use a combination of Base and Accent fonts applied to different elements.                                                                     |
| Minimal presets | Use only the Base font throughout the entire theme.                                                                                           |
